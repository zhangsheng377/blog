...
![See the source image](https://images.xiaozhuanlan.com/photo/2020/43bb4e716f757c9880c083e0d4b82e42.jpg)
...
误差=偏差+方差+噪声
$$
![img](https://img-blog.csdnimg.cn/img_convert/58fc2a3f24d17818d1efc353f389d5d9.png)
...
![img](https://www.analyticsvidhya.com/wp-content/uploads/2015/11/bigd.png)
...
而为什么有相关联性的多任务学习，可以提高模型总的正确率呢？是因为模型在每次训练的时候，都可以同时看到相关联的、更多的指标。就像是为什么模型蒸馏可以让小模型上，比直接学习任务目标，要效果更好呢？有一种解释是说，因为模型蒸馏对齐的是中间层的输出，也就相当于是让小模型从原来的学习分类，变成了学习分类的概率分布。这也就解释了为什么，有相关性的多任务学习，往往可以提高模型总的正确率。

在我们实际的实验中，这种多任务模型，与之前每层训练一个单任务的模型，相比，它的指标是有很大提升的。所以这个也是未来的一个演进方向。
